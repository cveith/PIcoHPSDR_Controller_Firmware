...
class Rotary(object):
    ...
    def __init__(self, min_val, max_val, reverse, range_mode, half_step, encoderAddress):
        ...
        self._listener = []
        self._encoderAddress = encoderAddress
    ...
    def setEncoderAddress(self, addr):
        self._encoderAddress = addr << 2
